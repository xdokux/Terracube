...
const float f_LM_RED = max_const(1.2 + LM_RED);
const float f_LM_GREEN = max_const(1.0 + LM_GREEN);
const float f_LM_BLUE = max_const(0.8 + LM_BLUE);

const float f_NOON_RED = max_const(1.25 + NOON_RED);
const float f_NOON_GREEN = max_const(1.15 + NOON_GREEN);
const float f_NOON_BLUE = max_const(1.0 + NOON_BLUE);

const float f_SUNRISE_RED = max_const(1.0 + SUNRISE_RED);
const float f_SUNRISE_GREEN = max_const(0.75 + SUNRISE_GREEN);
const float f_SUNRISE_BLUE = max_const(0.5 + SUNRISE_BLUE);

const float f_SUNSET_RED = max_const(1.1 + SUNSET_RED);
...
const float f_NOON_SKY_T_B = max_const(0.75 + NOON_SKY_T_B);

const float f_SUNRISE_SKY_T_R = max_const(0.45 + SUNRISE_SKY_T_R);
const float f_SUNRISE_SKY_T_G = max_const(0.35 + SUNRISE_SKY_T_G);
const float f_SUNRISE_SKY_T_B = max_const(0.5 + SUNRISE_SKY_T_B);

const float f_SUNSET_SKY_T_R = max_const(0.5 + SUNSET_SKY_T_R);
const float f_SUNSET_SKY_T_G = max_const(0.35 + SUNSET_SKY_T_G);
...
const float f_NOON_SKY_G_R = max_const(0.6 + NOON_SKY_G_R);
const float f_NOON_SKY_G_G = max_const(0.65 + NOON_SKY_G_G);
const float f_NOON_SKY_G_B = max_const(0.75 + NOON_SKY_G_B);

const float f_SUNRISE_SKY_G_R = max_const(0.55 + SUNRISE_SKY_G_R);
const float f_SUNRISE_SKY_G_G = max_const(0.5 + SUNRISE_SKY_G_G);
const float f_SUNRISE_SKY_G_B = max_const(0.55 + SUNRISE_SKY_G_B);

const float f_SUNSET_SKY_G_R = max_const(0.55 + SUNSET_SKY_G_R);
const float f_SUNSET_SKY_G_G = max_const(0.45 + SUNSET_SKY_G_G);
const float f_SUNSET_SKY_G_B = max_const(0.5 + SUNSET_SKY_G_B);

const float f_NIGHT_SKY_G_R = max_const(0.18 + NIGHT_SKY_G_R);
const float f_NIGHT_SKY_G_G = max_const(0.21 + NIGHT_SKY_G_G);
const float f_NIGHT_SKY_G_B = max_const(0.28 + NIGHT_SKY_G_B);

const float f_SUN_GLARE_R = max_const(0.8 + SUN_GLARE_R);
const float f_SUN_GLARE_G = max_const(0.55 + SUN_GLARE_G);
...
const float f_SUNRISE_AMBIENT = max_const(0.55 + SUNRISE_AMBIENT);
const float f_NOON_AMBIENT = max_const(0.65 + NOON_AMBIENT);
const float f_SUNSET_AMBIENT = max_const(0.55 + SUNSET_AMBIENT);
const float f_NIGHT_AMBIENT = max_const(0.3 + NIGHT_AMBIENT);
