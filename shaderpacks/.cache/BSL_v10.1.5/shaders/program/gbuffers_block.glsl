...
void main() {
	...
	float opaqueMask = float(gl_FragCoord.z < 1.0);
    ...
    gl_FragData[0] = albedo;
		...
		gl_FragData[3] = vec4(EncodeNormal(newNormal), opaqueMask, 1.0);
		...
		gl_FragData[2] = vec4(EncodeNormal(newNormal), opaqueMask, 1.0);
