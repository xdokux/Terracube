...
const float f_LM_BLUE = max_const(1.5 + LM_BLUE);

const float f_NOON_RED = max_const(1.3 + NOON_RED);
const float f_NOON_GREEN = max_const(1.2 + NOON_GREEN);
const float f_NOON_BLUE = max_const(1.5 + NOON_BLUE);

const float f_SUNRISE_RED = max_const(0.8 + SUNRISE_RED);
const float f_SUNRISE_GREEN = max_const(0.9 + SUNRISE_GREEN);
const float f_SUNRISE_BLUE = max_const(0.9 + SUNRISE_BLUE);

const float f_SUNSET_RED = max_const(0.9 + SUNSET_RED);
const float f_SUNSET_GREEN = max_const(0.7 + SUNSET_GREEN);
const float f_SUNSET_BLUE = max_const(0.4 + SUNSET_BLUE);

const float f_MOON_RED = max_const(0.6 + MOON_RED);
const float f_MOON_GREEN = max_const(0.5 + MOON_GREEN);
const float f_MOON_BLUE = max_const(0.4 + MOON_BLUE);

const float f_NOON_SKY_T_R = max_const(0.6 + NOON_SKY_T_R);
const float f_NOON_SKY_T_G = max_const(0.5 + NOON_SKY_T_G);
const float f_NOON_SKY_T_B = max_const(0.8 + NOON_SKY_T_B);

const float f_SUNRISE_SKY_T_R = max_const(0.0 + SUNRISE_SKY_T_R);
const float f_SUNRISE_SKY_T_G = max_const(0.5 + SUNRISE_SKY_T_G);
const float f_SUNRISE_SKY_T_B = max_const(0.7 + SUNRISE_SKY_T_B);

const float f_SUNSET_SKY_T_R = max_const(0.00 + SUNSET_SKY_T_R);
const float f_SUNSET_SKY_T_G = max_const(0.1 + SUNSET_SKY_T_G);
...
const float f_WATER_ALPHA = max_const(0.43 + WATER_ALPHA);
...
const float f_LM_RED = max_const(0.7 + LM_RED);
const float f_LM_GREEN = max_const(0.9 + LM_GREEN);
const float f_LM_BLUE = max_const(0.9 + LM_BLUE);

const float f_NOON_RED = max_const(0.8 + NOON_RED);
...
const float f_NOON_SKY_T_R = max_const(0.35 + NOON_SKY_T_R);
...
const float f_SUNSET_SKY_G_R = max_const(0.50 + SUNSET_SKY_G_R);
const float f_SUNSET_SKY_G_G = max_const(0.40 + SUNSET_SKY_G_G);
const float f_SUNSET_SKY_G_B = max_const(0.48 + SUNSET_SKY_G_B);
...
const float f_SUN_GLARE_G = max_const(0.8 + SUN_GLARE_G);
const float f_SUN_GLARE_B = max_const(0.0 + SUN_GLARE_B);
...
const float f_SUNSET_AMBIENT = max_const(0.5 + SUNSET_AMBIENT);
const float f_NIGHT_AMBIENT = max_const(0.4 + NIGHT_AMBIENT);

const float f_WATER_RED = max_const(0.0 + WATER_RED);
const float f_WATER_GREEN = max_const(0.4 + WATER_GREEN);
const float f_WATER_BLUE = max_const(0.6 + WATER_BLUE);
const float f_WATER_ALPHA = max_const(0.6 + WATER_ALPHA);

const float f_BIOME_WATER_CONTRIBUTION = max_const(0.0 + BIOME_WATER_CONTRIBUTION);

// Ethereal - soft pastel dreamy tones
#elif COLOR_SCHEME == 4

const float f_LM_RED = max_const(1.1 + LM_RED);
const float f_LM_GREEN = max_const(0.85 + LM_GREEN);
const float f_LM_BLUE = max_const(1.3 + LM_BLUE);

const float f_NOON_RED = max_const(1.15 + NOON_RED);
const float f_NOON_GREEN = max_const(1.1 + NOON_GREEN);
const float f_NOON_BLUE = max_const(1.35 + NOON_BLUE);

const float f_SUNRISE_RED = max_const(0.95 + SUNRISE_RED);
const float f_SUNRISE_GREEN = max_const(0.7 + SUNRISE_GREEN);
const float f_SUNRISE_BLUE = max_const(0.85 + SUNRISE_BLUE);

const float f_SUNSET_RED = max_const(0.85 + SUNSET_RED);
const float f_SUNSET_GREEN = max_const(0.55 + SUNSET_GREEN);
const float f_SUNSET_BLUE = max_const(0.65 + SUNSET_BLUE);

const float f_MOON_RED = max_const(0.45 + MOON_RED);
const float f_MOON_GREEN = max_const(0.5 + MOON_GREEN);
const float f_MOON_BLUE = max_const(0.65 + MOON_BLUE);

const float f_NOON_SKY_T_R = max_const(0.5 + NOON_SKY_T_R);
const float f_NOON_SKY_T_G = max_const(0.45 + NOON_SKY_T_G);
const float f_NOON_SKY_T_B = max_const(0.85 + NOON_SKY_T_B);

const float f_SUNRISE_SKY_T_R = max_const(0.15 + SUNRISE_SKY_T_R);
const float f_SUNRISE_SKY_T_G = max_const(0.35 + SUNRISE_SKY_T_G);
const float f_SUNRISE_SKY_T_B = max_const(0.75 + SUNRISE_SKY_T_B);

const float f_SUNSET_SKY_T_R = max_const(0.2 + SUNSET_SKY_T_R);
const float f_SUNSET_SKY_T_G = max_const(0.15 + SUNSET_SKY_T_G);
const float f_SUNSET_SKY_T_B = max_const(0.5 + SUNSET_SKY_T_B);
...
const float f_SUN_GLARE_R = max_const(0.75 + SUN_GLARE_R);
const float f_SUN_GLARE_G = max_const(0.5 + SUN_GLARE_G);
const float f_SUN_GLARE_B = max_const(0.15 + SUN_GLARE_B);

const float f_NETHER_AMBIENT_R = max_const(0.4 + NETHER_AMBIENT_R);
const float f_NETHER_AMBIENT_G = max_const(0.28 + NETHER_AMBIENT_G);
const float f_NETHER_AMBIENT_B = max_const(0.35 + NETHER_AMBIENT_B);

const float f_END_AMBIENT_R = max_const(0.22 + END_AMBIENT_R);
const float f_END_AMBIENT_G = max_const(0.18 + END_AMBIENT_G);
const float f_END_AMBIENT_B = max_const(0.3 + END_AMBIENT_B);

const float f_END_DIRECT_R = max_const(0.28 + END_DIRECT_R);
...
const float f_END_AURORA1_G = max_const(0.5 + END_AURORA1_G);
...
const float f_WATER_RED = max_const(0.05 + WATER_RED);
const float f_WATER_GREEN = max_const(0.35 + WATER_GREEN);
const float f_WATER_BLUE = max_const(0.55 + WATER_BLUE);
