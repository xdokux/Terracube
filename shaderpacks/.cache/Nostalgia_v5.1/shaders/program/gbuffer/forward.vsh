...
#define USE_SIMPLE_SKYLIGHT
#define SIMPLE_SKYLIGHT_APPROX
...
void main() {
    ...
    shadowPosition.z *= shadowMapDepthConst;
    shadowPosition  = shadowPosition * 0.5 + 0.5;

    #ifdef gTEXTURED
        #if (defined normalmapEnabled || defined gTERRAIN)
    ...
    #ifndef DIM
    directColor         = (sunAngle < 0.5 ? lightColor[0] : lightColor[1]) * lightFlip;
    #else
