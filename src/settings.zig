...
/// Directory name under `shaderpacks/` to load an OptiFine/Iris shaderpack from, or empty for
/// Cubyz's own rendering. The pack is loaded on the first frame after a world is entered.
pub var shaderPack: []const u8 = "";
